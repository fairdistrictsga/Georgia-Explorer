...
// change cursor to pointer
    ...
    if (features.length) {
        ...
        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Map proposed by Senate Democratic Caucus, Oct. 28, 2021' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'Proposed State Senate District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
        '</br>' + 'Percent Asian VAP: ' + '<strong>' + (e.features[0].properties.pct_avp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "senate_p2_popup", function(e) {
  $('#sidebar').show();
// create hover effect
    map.setFilter("senate_p2_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
    map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["senate_p2_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Map proposed by Senate Committee Chair, Nov. 2, 2021' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'Proposed State Senate District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
        ...
        '</br>' + 'Percent Hispanic VAP: ' + '<strong>' + (e.features[0].properties.pct_hvp * 100).toFixed() + '%' + '</strong>' +
        '</br>' + 'Percent Minority VAP: ' + '<strong>' + (e.features[0].properties.pct_bp_ * 100).toFixed() + '%' + '</strong>' +
        '</br>' + 'Partisan Lean Estimate, Percent Democrat 2018-21: ' + '<strong>' + (e.features[0].properties.partisan * 100).toFixed() + '%' + '</strong>';
    } else {
        document.getElementById('tooltip-name').innerHTML = "";
        document.getElementById('tooltip').innerHTML = "";
    }
...
// change cursor to pointer
    ...
    if (features.length) {
        ...
        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Previous State Senate Map (2021 - 2023)' + '</strong>' + '</span>' + '</br>' + 
        '<span class="tooltip-title">' + 'State Senate District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "senate_r1_popup", function(e) {
  $('#sidebar').show();
// create hover effect
    map.setFilter("senate_r1_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
    map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["senate_r1_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Enacted Senate Map' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'State Senate District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "senate_r2_popup", function(e) {
  $('#sidebar').show();
// create hover effect
    map.setFilter("senate_r2_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
    map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["senate_r2_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'GSDC Senate Remedy Map' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'State Senate District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';
    ...
    if (features.length) {
        ...
        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Previous State House Map (2015 - 2021)' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'State House District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
        '</br>' + 'Percent Asian VAP: ' + '<strong>' + (e.features[0].properties.pct_avp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "house_p1_popup", function(e) {
  $('#sidebar').show();
// create hover effect
  map.setFilter("house_p1_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["house_p1_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Map proposed by House Democratic Caucus, Oct. 29, 2021' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'Proposed State House District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
        '</br>' + 'Percent Asian VAP: ' + '<strong>' + (e.features[0].properties.pct_avp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "house_p2_popup", function(e) {
  $('#sidebar').show();
// create hover effect
  map.setFilter("house_p2_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["house_p2_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Map proposed by House Committee Chair, Nov. 2, 2021' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'Proposed State House District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "house_p3_popup", function(e) {
  $('#sidebar').show();
// create hover effect
  map.setFilter("house_p3_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["house_p3_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Previous State House Map (2021 - 2023)' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'State House District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "house_r1_popup", function(e) {
  $('#sidebar').show();
// create hover effect
  map.setFilter("house_r1_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["house_r1_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Enacted House Map' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'State House District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "house_r2_popup", function(e) {
  $('#sidebar').show();
// create hover effect
  map.setFilter("house_r2_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["house_r2_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'House GSDC Remedy Map' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'State House District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';
    ...
    if (features.length) {
        ...
        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Previous Congressional Map (2011 - 2021)' + '</strong>' + '</span>' + '</br>' +
        '<h4>' + 'Congressional District ' + e.features[0].properties.district + '</h4>' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
        '</br>' + 'Percent Asian VAP: ' + '<strong>' + (e.features[0].properties.pct_avp * 100).toFixed() + '%' + '</strong>' +
...
// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';
    ...
    if (features.length) {
        ...
        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Map proposed by Senate Committee Chair, Sept. 27, 2021' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + '<strong>' + 'Proposed ' + '</strong>' + 'Congressional District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
        '</br>' + 'Percent Asian VAP: ' + '<strong>' + (e.features[0].properties.pct_avp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "congress_proposed_2_popup", function(e) {
  $('#sidebar').show();
// create hover effect
  map.setFilter("congress_proposed_2_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["congress_proposed_2_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Map proposed by House and Senate Democratic Caucuses, Oct. 21, 2021' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + '<strong>' + 'Proposed ' + '</strong>' + 'Congressional District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';
    ...
    if (features.length) {
        ...
        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Previous Congressional Map (2021 - 2023)' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'Congressional District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
        '</br>' + 'Percent Asian VAP: ' + '<strong>' + (e.features[0].properties.pct_avp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "congress_r1_popup", function(e) {
  $('#sidebar').show();
// create hover effect
  map.setFilter("congress_r1_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["congress_r1_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'Enacted US Congress Map' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'Congressional District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
map.on("mousemove", "congress_r2_popup", function(e) {
  $('#sidebar').show();
// create hover effect
  map.setFilter("congress_r2_hover", ["==", "district", e.features[0].properties.district]);

// change cursor to pointer
  map.getCanvas().style.cursor = 'pointer';

    var features = map.queryRenderedFeatures(e.point, {
        layers: ["congress_r2_popup"]
    });

    if (features.length) {

        document.getElementById('tooltip').innerHTML = 
        '<span class="tooltip-title">' + '<strong>' + 'US Congress GHDC & GSDC Remedy Map' + '</strong>' + '</span>' + '</br>' +
        '<span class="tooltip-title">' + 'Congressional District ' + e.features[0].properties.district + '</span class="tooltip-title">' + '</br>' +
                  'Population, 2020: ' + '<strong>' + e.features[0].properties.pop.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Voting Age Population (VAP), 2020: ' + '<strong>' + e.features[0].properties.tvap.toLocaleString("en-US") + '</strong>' +
        '</br>' + 'Percent Black VAP: ' + '<strong>' + (e.features[0].properties.pct_bvp * 100).toFixed() + '%' + '</strong>' +
...
// Reset the state-fills-hover layer's filter when the mouse leaves the layer.
map.on("mouseleave", "senate_r1_popup", function() {
// remove hover color
    map.setFilter("senate_r1_hover", ["==", "district", ""]);
// remove popup
    popup.remove();  // make this work, and create a hover handler
    document.getElementById('tooltip').innerHTML = "";
    map.getCanvas().style.cursor = 'default';
...
// Reset the state-fills-hover layer's filter when the mouse leaves the layer.
map.on("mouseleave", "senate_r2_popup", function() {
// remove hover color
    map.setFilter("senate_r2_hover", ["==", "district", ""]);
// remove popup
    popup.remove();  // make this work, and create a hover handler
    document.getElementById('tooltip').innerHTML = "";
    map.getCanvas().style.cursor = 'default';
...
// Reset the state-fills-hover layer's filter when the mouse leaves the layer.
map.on("mouseleave", "house_p1_popup", function() {
// remove hover color
    map.setFilter("house_p1_hover", ["==", "district", ""]);
// remove popup
    popup.remove();  // make this work, and create a hover handler
    document.getElementById('tooltip').innerHTML = "";
    map.getCanvas().style.cursor = 'default';
...
// Reset the state-fills-hover layer's filter when the mouse leaves the layer.
map.on("mouseleave", "house_p2_popup", function() {
// remove hover color
    map.setFilter("house_p2_hover", ["==", "district", ""]);
// remove popup
    popup.remove();  // make this work, and create a hover handler
    document.getElementById('tooltip').innerHTML = "";
    map.getCanvas().style.cursor = 'default';
...
// Reset the state-fills-hover layer's filter when the mouse leaves the layer.
map.on("mouseleave", "house_p3_popup", function() {
// remove hover color
    map.setFilter("house_p3_hover", ["==", "district", ""]);
// remove popup
    popup.remove();  // make this work, and create a hover handler
    document.getElementById('tooltip').innerHTML = "";
    map.getCanvas().style.cursor = 'default';
...
// Reset the state-fills-hover layer's filter when the mouse leaves the layer.
map.on("mouseleave", "house_r1_popup", function() {
// remove hover color
    map.setFilter("house_r1_hover", ["==", "district", ""]);
// remove popup
    popup.remove();  // make this work, and create a hover handler
    document.getElementById('tooltip').innerHTML = "";
    map.getCanvas().style.cursor = 'default';
...
// Reset the state-fills-hover layer's filter when the mouse leaves the layer.
map.on("mouseleave", "house_r2_popup", function() {
// remove hover color
    map.setFilter("house_r2_hover", ["==", "district", ""]);
// remove popup
    popup.remove();  // make this work, and create a hover handler
    document.getElementById('tooltip').innerHTML = "";
    map.getCanvas().style.cursor = 'default';
...
// Reset the state-fills-hover layer's filter when the mouse leaves the layer.
map.on("mouseleave", "congress_r1_popup", function() {
// remove hover color
    map.setFilter("congress_r1_hover", ["==", "district", ""]);
// remove popup
    popup.remove();  // make this work, and create a hover handler
    document.getElementById('tooltip').innerHTML = "";
    map.getCanvas().style.cursor = 'default';
...
// Reset the state-fills-hover layer's filter when the mouse leaves the layer.
map.on("mouseleave", "congress_r2_popup", function() {
// remove hover color
    map.setFilter("congress_r2_hover", ["==", "district", ""]);
// remove popup
    popup.remove();  // make this work, and create a hover handler
    document.getElementById('tooltip').innerHTML = "";
    map.getCanvas().style.cursor = 'default';
...
// adding legend
    ...
    var standardLegends = [
      ...
      [
        { title: 'Partisan Lean, Percent Democrat (2018-2022)', id: 'precinct_pleanLegendTitle', class: 'precinct_pleanLegend dataTitle' },
...
(function( Georgia ) {
  ...
  const leg_layers = [
    'senate',   'senate_p1', 'senate_p2', 'senate_p3', 'senate_r1', 'senate_r2',
    'house',    'house_p1', 'house_p2', 'house_p3', 'house_r1', 'house_r2',
    'congress', 'congress_proposed',
    'congress_proposed_2', 'congress_proposed_3', 'congress_r1',  'congress_r2'
  ];
  ...
  const leg_fill_layers = [
    'senate_fill',    'senate_p1_fill', 'senate_p2_fill', 'senate_p3_fill',  'senate_r1_fill',  'senate_r2_fill',
    'house_fill',     'house_p1_fill', 'house_p2_fill', 'house_p3_fill',  'house_r1_fill',  'house_r2_fill',
    'congress_fill',  'congress_proposed_fill', 'congress_proposed_2_fill',
    'congress_proposed_3_fill', 'congress_r1_fill', 'congress_r2_fill'
  ];

  const leg_popup_layers = [
    'senate_popup',    'senate_p1_popup', 'senate_p2_popup', 'senate_p3_popup',  'senate_r1_popup',  'senate_r2_popup',
    'house_popup',     'house_p1_popup', 'house_p2_popup', 'house_p3_popup', 'house_r1_popup', 'house_r2_popup',
    'congress_popup',  'congress_proposed_popup', 'congress_proposed_2_popup',
    'congress_proposed_3_popup', 'congress_r1_popup', 'congress_r2_popup'
  ];
